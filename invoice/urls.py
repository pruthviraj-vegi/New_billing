...
urlpatterns = [
    ...
    path("audits/manager/<int:pk>/", views_.InvoiceManager.as_view(), name="invoice_manager"),

    path("audits/detail/<int:pk>/", views_.audit_detail, name="audit_detail"),
    path("audits/delete/<int:pk>/", views_.AuditTableDeleteView.as_view(), name="audit_delete"),
