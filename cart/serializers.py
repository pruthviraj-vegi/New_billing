...
class ProductVariantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'barcode', 'full_name', 'mrp', 'brand', 'simple_name', 'discount_percentage']
...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = [
            'id', 'cart', 'product_variant', 'product_variant_id',
            'quantity', 'price', 'amount', 'product_name',
            'discount_percentage', 'created_at', 'updated_at'
        ]
        read_only_fields = ['cart', 'amount', 'product_name', 'discount_percentage', 'created_at', 'updated_at']
...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = [
            'id', 'name', 'status', 'notes', 'created_by',
            'created_at', 'updated_at', 'cart_items', 'total_amount', 'item_count'
        ]
