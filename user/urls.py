...
urlpatterns = [
    ...
    path("sessions/invalidate/all/", views.invalidate_all_sessions, name="invalidate_all_sessions"),
    path("sessions/invalidate/<str:session_key>/", views.invalidate_session, name="invalidate_session"),
