!(function(a) {
  ...
  var c = function(c, d) {
    var e,
          ...
          void 0 === a || null === a
            ...
            : b.isDate(a) || b.isMoment(a)
              ...
              : x()
                ...
                : b(a, j, d.useStrict)), x() && c.tz(d.timeZone), c;
      },
      z = function(a) {
      ...
      G = function() {
        var b = a("<div>").addClass(
          ...
          g = a("<li>")
            ...
            .append(F());
        return d.inline && b.removeClass("dropdown-menu"), h &&
          b.addClass("usetwentyfour"), z("s") &&
          !h &&
          b.addClass("wider"), d.sideBySide && B() && A()
          ? (
      ...
      H = function() {
        ...
        return (b =
          c.is("input") || d.inline
            ? c.data()
            : c.find("input").data()), b.dateOptions &&
      ...
      M = function() {
        ...
        for (
          ...
          b.append(a("<th>").addClass("dow").text(c.format("dd"))), c.add(
            1,
            "d"
          );
      ...
      T = function() {
        ...
        c.eq(0).find("span").attr("title", d.tooltips.prevYear), c
          .eq(1)
          .attr("title", d.tooltips.selectYear), c
          .eq(2)
          .find("span")
          .attr("title", d.tooltips.nextYear), b
          .find(".disabled")
          .removeClass("disabled"), R(f.clone().subtract(1, "y"), "y") ||
          c.eq(0).addClass("disabled"), c.eq(1).text(f.year()), R(
          f.clone().add(1, "y"),
          "y"
        ) || c.eq(2).addClass("disabled"), g.removeClass("active"), e.isSame(
          f,
          "y"
        ) &&
          !m &&
          g.eq(e.month()).addClass("active"), g.each(function(b) {
      ...
      U = function() {
        var a = o.find(".datepicker-years"),
          ...
          h = "";
        for (
          b.eq(0).find("span").attr("title", d.tooltips.prevDecade), b
            .eq(1)
            .attr("title", d.tooltips.selectDecade), b
            .eq(2)
            .find("span")
            .attr("title", d.tooltips.nextDecade), a
            .find(".disabled")
            .removeClass("disabled"), d.minDate &&
            d.minDate.isAfter(c, "y") &&
            b.eq(0).addClass("disabled"), b
            .eq(1)
            .text(c.year() + "-" + g.year()), d.maxDate &&
      ...
      V = function() {
        var a,
          ...
          m = "";
        for (
          g.eq(0).find("span").attr("title", d.tooltips.prevCentury), g
            .eq(2)
            .find("span")
            .attr("title", d.tooltips.nextCentury), c
            .find(".disabled")
            .removeClass("disabled"), (h.isSame(b({ y: 1900 })) ||
            (d.minDate && d.minDate.isAfter(h, "y"))) &&
            g.eq(0).addClass("disabled"), g
            .eq(1)
            .text(h.year() + "-" + i.year()), (h.isSame(b({ y: 2e3 })) ||
          ...
          (a = h.year() + 12), (k =
            ...
            (h.year() + 12) +
            "</span>"), h.add(12, "y");
        (m += "<span></span><span></span><span></span>"), c
          .find("td")
          .html(m), g.eq(1).text(j.year() + 1 + "-" + h.year());
      },
      W = function() {
        var b,
          c,
        ...
        if (B()) {
          for (
            i.eq(0).find("span").attr("title", d.tooltips.prevMonth), i
              .eq(1)
              .attr("title", d.tooltips.selectMonth), i
              .eq(2)
              .find("span")
              .attr("title", d.tooltips.nextMonth), h
              .find(".disabled")
              .removeClass("disabled"), i
              .eq(1)
              .text(f.format(d.dayViewHeaderFormat)), R(
              f.clone().subtract(1, "M"),
              "M"
            ) || i.eq(0).addClass("disabled"), R(f.clone().add(1, "M"), "M") ||
              i.eq(2).addClass("disabled"), b = f
              .clone()
              .startOf("M")
              .startOf("w")
              .startOf("d"), g = 0;
            ...
            0 === b.weekday() &&
              (
                ...
                j.push(c)
              ), (k = ["day"]), b.isBefore(f, "M") && k.push("old"), b.isAfter(
              f,
              "M"
            ) && k.push("new"), b.isSame(e, "d") && !m && k.push("active"), R(
              b,
              "d"
            ) || k.push("disabled"), b.isSame(y(), "d") &&
              k.push("today"), (0 !== b.day() && 6 !== b.day()) ||
              k.push("weekend"), J({
              type: "dp.classify",
              date: b,
              classNames: k
      ...
      X = function() {
        ...
        for (
          ...
          c.hour() % 4 === 0 && ((e = a("<tr>")), d.push(e)), e.append(
      ...
      Z = function() {
        for (
          ...
          c.second() % 20 === 0 && ((e = a("<tr>")), d.push(e)), e.append(
      ...
      da = function(a) {
        return void 0 === d.parseInputDate
          ? (!b.isMoment(a) || a instanceof Date) && (a = y(a))
          : (a = d.parseInputDate(a)), a;
      },
      ea = {
        next: function() {
          var a = q[k].navFnc;
        ...
        selectMonth: function(b) {
          ...
          f.month(c), k === p
            ? (aa(e.clone().year(f.year()).month(f.month())), d.inline || ba())
            : (L(-1), W()), K("M");
        },
        ...
        selectDay: function(b) {
          var c = f.clone();
          a(b.target).is(".old") && c.subtract(1, "M"), a(b.target).is(
            ".new"
          ) && c.add(1, "M"), aa(
        ...
        togglePicker: function(b) {
          ...
          if (g && g.length) {
            ...
            g.collapse
              ...
              : (g.removeClass("in"), h.addClass("in")), e.is("span")
              ? e.toggleClass(d.icons.time + " " + d.icons.date)
              : e.find("span").toggleClass(d.icons.time + " " + d.icons.date);
          }
        },
        showPicker: function() {
          o.find(".timepicker > div:not(.timepicker-picker)").hide(), o
            .find(".timepicker .timepicker-picker")
            .show();
        },
        showHours: function() {
          o.find(".timepicker .timepicker-picker").hide(), o
        ...
        selectHour: function(b) {
          ...
          h ||
            (e.hours() >= 12 ? 12 !== c && (c += 12) : 12 === c && (c = 0)), aa(
            e.clone().hours(c)
          ), ea.showPicker.call(l);
        },
        selectMinute: function(b) {
          aa(
            e.clone().minutes(parseInt(a(b.target).text(), 10))
          ), ea.showPicker.call(l);
        },
        selectSecond: function(b) {
          aa(
            e.clone().seconds(parseInt(a(b.target).text(), 10))
          ), ea.showPicker.call(l);
        },
        clear: ca,
        today: function() {
      ...
      pa = function() {
        ...
        })), (j = d.extraFormats ? d.extraFormats.slice() : []), j.indexOf(a) <
          0 &&
          j.indexOf(i) < 0 &&
          j.push(i), (h =
          i.toLowerCase().indexOf("a") < 1 &&
          i.replace(/\[.*?\]/g, "").indexOf("h") < 1), z("y") && (p = 2), z(
          "M"
        ) && (p = 1), z("d") && (p = 0), (k = Math.max(p, k)), m || aa(e);
      };
    if (
      (
        (l.destroy = function() {
        ...
        (l.hide = ba),
        (l.disable = function() {
          return ba(), n && n.hasClass("btn") && n.addClass("disabled"), g.prop(
            "disabled",
            !0
          ), l;
        }),
        (l.enable = function() {
          return n && n.hasClass("btn") && n.removeClass("disabled"), g.prop(
            "disabled",
            !1
          ), l;
        }),
        ...
        (l.maxDate = function(a) {
          ...
          return (d.maxDate = b), d.useCurrent &&
            !d.keepInvalid &&
            e.isAfter(a) &&
            aa(d.maxDate), f.isAfter(b) &&
        ...
        (l.minDate = function(a) {
          ...
          return (d.minDate = b), d.useCurrent &&
            !d.keepInvalid &&
            e.isBefore(a) &&
            aa(d.minDate), f.isBefore(b) &&
        ...
        (l.locale = function(a) {
          ...
          return (d.locale = a), e.locale(d.locale), f.locale(d.locale), i &&
            pa(), o && (ba(), ga()), l;
        }),
    ...
    return (e = y()), (f = e.clone()), a.extend(!0, d, H()), l.options(
      d
    ), pa(), la(), g.prop("disabled") && l.disable(), g.is("input") &&
    0 !== g.val().trim().length
      ? aa(da(g.val().trim()))
      : d.defaultDate &&
