...
(function(t) {
  ...
  (t.cleanData = (function(e) {
    ...
    return s || ((s = i), (i = t.Widget)), t.isArray(s) &&
      (s = t.extend.apply(null, [{}].concat(s))), (t.expr[":"][
      l.toLowerCase()
    ] = function(e) {
      return !!t.data(e, l);
            ...
            (r[e] = (function() {
              ...
              return function() {
                ...
                return (this._super = t), (this._superApply = n), (e = s.apply(
                  this,
                  arguments
                )), (this._super = i), (this._superApply = o), e;
              };
            })()),
            void 0
          )
    ...
    _createWidget: function(e, i) {
      (i = t(i || this.defaultElement || this)[0]), (this.element = t(
        i
      )), (this.uuid = h++), (this.eventNamespace =
        "." +
        this.widgetName +
        this
          .uuid), (this.bindings = t()), (this.hoverable = t()), (this.focusable = t()), (this.classesElementLookup = {}), i !==
        this &&
        (
    ...
    _classes: function(e) {
      function i(i, o) {
        ...
        for (r = 0; i.length > r; r++)
          (a = n.classesElementLookup[i[r]] || t()), (a = e.add
            ? t(t.unique(a.get().concat(e.element.get())))
            : t(a.not(e.element).get())), (n.classesElementLookup[
            i[r]
          ] = a), s.push(i[r]), o && e.classes[i[r]] && s.push(e.classes[i[r]]);
      }
      var s = [],
        n = this;
      return (e = t.extend(
        ...
        e
      )), this._on(e.element, { remove: "_untrackClassesElement" }), e.keys &&
    ...
    (t.position = {
      scrollbarWidth: function() {
        ...
        var e,
          ...
          o = s.children()[0];
        return t("body").append(s), (e = o.offsetWidth), s.css(
          "overflow",
          "scroll"
        ), (i = o.offsetWidth), e === i &&
      ...
      var u,
        ...
        k = {};
      return (_ = s(v)), v[0].preventDefault && (n.at = "left top"), (p =
        _.width), (f = _.height), (g = _.offset), (m = t.extend(
        {},
        g
          ...
          (i = r.test(i[0])
            ...
            : h.test(i[0])
              ...
              : [
                  "center",
                  "center"
                ]), (i[0] = r.test(i[0]) ? i[0] : "center"), (i[1] = h.test(i[1]) ? i[1] : "center"), (t = l.exec(i[0])), (e = l.exec(i[1])), (k[this] = [t ? t[0] : 0, e ? e[0] : 0]), (n[this] = [c.exec(i[0])[0], c.exec(i[1])[0]]);
      }), 1 === w.length && (w[1] = w[0]), "right" === n.at[0]
        ? (m.left += p)
        : "center" === n.at[0] && (m.left += p / 2), "bottom" === n.at[1]
        ? (m.top += f)
        : "center" === n.at[1] && (m.top += f / 2), (u = e(
        k.at,
        p,
        f
        ...
        "right" === n.my[0]
          ...
          : "center" === n.my[0] &&
            (D.left -=
              l /
              2), "bottom" === n.my[1] ? (D.top -= c) : "center" === n.my[1] && (D.top -= c / 2), (D.left += I[0]), (D.top += I[1]), (s = { marginLeft: d, marginTop: _ }), t.each(
          ["left", "top"],
          function(e, i) {
            t.ui.position[w[e]] &&
  ...
  (t.effects = { effect: {} }), (function(t, e) {
    ...
    function n(t, e, i) {
      return (i =
        (i + 1) %
        1), 1 > 6 * i ? t + 6 * (e - t) * i : 1 > 2 * i ? e : 2 > 3 * i ? t + 6 * (e - t) * (2 / 3 - i) : t;
    }
    var o,
      a =
      ...
      f = t.each;
    (p.style.cssText =
      "background-color:rgba(1,1,1,.5)"), (d.rgba = p.style.backgroundColor.indexOf("rgba") > -1), f(c, function(t, e) {
      (e.cache =
    ...
    function e(e, i, s, n) {
      return t.isPlainObject(e) &&
        (
          (i = e),
          (e = e.effect)
        ), (e = { effect: e }), null == i && (i = {}), t.isFunction(i) && ((n = i), (s = null), (i = {})), ("number" == typeof i || t.fx.speeds[i]) && ((n = s), (s = i), (i = {})), t.isFunction(s) && ((n = s), (s = null)), i && t.extend(e, i), (s = s || i.duration), (e.duration = t.fx.off ? 0 : "number" == typeof s ? s : s in t.fx.speeds ? t.fx.speeds[s] : t.fx.speeds._default), (e.complete = n || i.complete), e;
    }
    function i(e) {
  ...
  t.effects.define("blind", "hide", function(e, i) {
    ...
    (r.clip[s[o][0]] =
      r.clip[
        s[o][1]
      ]), "show" === e.mode && (n.cssClip(r.clip), h && h.css(t.effects.clipToBox(r)), (r.clip = a)), h && h.animate(t.effects.clipToBox(r), e.duration, e.easing), n.animate(r, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
    ...
    var s,
      ...
      b = a.queue().length;
    for (
      t.effects.createPlaceholder(a), o = a.css(m), u ||
        (u = a["top" === m ? "outerHeight" : "outerWidth"]() / 3), l &&
        (
          (n = { opacity: 1 }),
          (n[m] = o),
    ...
    t.effects.createPlaceholder(
      n
    ), (s = e.distance || n["top" === h ? "outerHeight" : "outerWidth"](!0) / 2), (u[h] = l + s), a && (n.css(u), (u[h] = c + s), (u.opacity = 1)), n.animate(u, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
    ...
    h &&
      (r =
        ...
        m[
          a ? 0 : 1
        ]), (f.clip[c[0]] = r), (g.clip[c[0]] = r), (g.clip[c[1]] = 0), o && (s.cssClip(g.clip), d && d.css(t.effects.clipToBox(g)), (g.clip = p)), s
      .queue(function(i) {
        d &&
          d
    ...
    "hide" === e.mode &&
      (n.opacity = 0), t.effects.saveStyle(s), s.css({ backgroundImage: "none", backgroundColor: e.color || "#ffff99" }).animate(n, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
      ...
      (
        ...
        a.find("*[width]").each(function() {
          ...
          n.from.y !== n.to.y &&
            ...
            ), n.from.x !== n.to.x && ((o = t.effects.setTransition(i, l, n.from.x, o)), (a = t.effects.setTransition(i, l, n.to.x, a))), u && t.effects.saveStyle(i), i.css(o), i.animate(
            a,
            e.duration,
            e.easing,
            function() {
    ...
    var s = 1,
      ...
      g = n.queue().length;
    for (
      t.effects.createPlaceholder(n), d[c] = (u ? "-=" : "+=") + a, p[c] =
        (u ? "+=" : "-=") + 2 * a, f[c] = (u ? "-=" : "+=") + 2 * a, n.animate(
        d,
        l,
        e.easing
      );
    ...
    t.effects.createPlaceholder(
      o
    ), (s = o.cssClip()), (n = o.position()[l]), (d[l] = (c ? -1 : 1) * u + n), (d.clip = o.cssClip()), (d.clip[a[h][1]] = d.clip[a[h][0]]), "show" === r && (o.cssClip(d.clip), o.css(l, d[l]), (d.clip = s), (d[l] = n)), o.animate(d, { queue: !1, duration: e.duration, easing: e.easing, complete: i });
  });
  var f;
  t.uiBackCompat !== !1 &&
        ...
        function s(e, i, s, o) {
          return t.each(n, function() {
            (i -=
              ...
              0), s && (i -= parseFloat(t.css(e, "border" + this + "Width")) || 0), o && (i -= parseFloat(t.css(e, "margin" + this)) || 0);
          }), i;
        }
    ...
    _destroy: function() {
      var t;
      this.element.removeAttr("role"), this.headers
        .removeAttr("role aria-expanded aria-selected aria-controls tabIndex")
        .removeUniqueId(), this._destroyIcons(), (t = this.headers
        .next()
        .css("display", "")
    ...
    _refresh: function() {
      ...
      ), this.active.next().show(), this.headers
        .attr("role", "tab")
        .each(function() {
          var e = t(this),
            ...
            this.headers
              ...
              .each(function() {
                ...
                i ||
                  t(
                    this
                  ).show(), (e = Math.max(e, t(this).css("height", "").height())), i || t(this).hide();
              })
              .height(e)
          );
    },
    ...
    _animate: function(t, e, i) {
      ...
      return "number" == typeof u && (o = u), "string" == typeof u &&
        (n = u), (n = n || u.easing || c.easing), (o =
        o || u.duration || c.duration), e.length
        ? t.length
          ? (
    ...
    _toggleComplete: function(t) {
      var e = t.oldPanel,
        i = e.prev();
      this._removeClass(e, "ui-accordion-content-active"), this._removeClass(
        i,
        "ui-accordion-header-active"
    ...
    refresh: function() {
      ...
      this._toggleClass(
      ...
      ), (e = h.add(this.element)), (i = e.find(this.options.items)), i
        .not(".ui-menu-item")
        .each(function() {
          var e = t(this);
          a._isDivider(e) &&
        ...
        n,
        "ui-menu-item"
      )._addClass(o, "ui-menu-item-wrapper"), i
    ...
    _setOptionDisabled: function(t) {
      this._super(t), this.element.attr(
        "aria-disabled",
        t + ""
    ...
    focus: function(t, e) {
      ...
      this.blur(t, t && "focus" === t.type), this._scrollIntoView(
        e
      ), (this.active = e.first()), (s = this.active.children(
        ".ui-menu-item-wrapper"
      )), this._addClass(s, null, "ui-state-active"), this.options.role &&
        this.element.attr(
    ...
    collapseAll: function(e, i) {
      clearTimeout(this.timer), (this.timer = this._delay(function() {
        ...
        s.length ||
          (s = this
            .element), this._close(s), this.blur(e), this._removeClass(s.find(".ui-state-active"), null, "ui-state-active"), (this.activeMenu = s);
      }, this.delay));
    },
    _close: function(t) {
      ...
      (this.isMultiLine =
        ...
        mousedown: function(e) {
          e.preventDefault(), (this.cancelBlur = !0), this._delay(function() {
            delete this
              .cancelBlur, this.element[0] !== t.ui.safeActiveElement(this.document[0]) && this.element.trigger("focus");
          });
        },
    ...
    _appendTo: function() {
      ...
      return e &&
        ...
        e[0]) ||
        (e = this.element.closest(".ui-front, dialog")), e.length ||
  ...
  t.widget("ui.controlgroup", {
    ...
    _destroy: function() {
      ...
      ), this.element.removeAttr("role"), this.options.items
        .controlgroupLabel &&
        this.element
    ...
    _spinnerOptions: function(t) {
      ...
      return (e.classes["ui-spinner-up"] = ""), (e.classes["ui-spinner-down"] =
        ""), e;
    },
    ...
    refresh: function() {
      ...
      this._addClass(
        ...
        this._addClass(
          null,
          "ui-helper-clearfix"
        ), this._initWidgets(), (e = this.childWidgets), this.options
        .onlyVisible && (e = e.filter(":visible")), e.length &&
        (
          t.each(["first", "last"], function(t, s) {
            ...
            if (n && i["_" + n.widgetName + "Options"]) {
              ...
              (o.classes = i._resolveClassesValues(o.classes, n)), n.element[
                n.widgetName
              ](o);
    ...
    t.ui.formResetMixin,
    {
      ...
      _getCreateOptions: function() {
        ...
        return this._readType(), (i = this.element.labels()), (this.label = t(
          ...
          }), this.originalLabel && (n.label = this.originalLabel), (e = this
          .element[0].disabled), null != e && (n.disabled = e), n;
      },
      _create: function() {
        ...
        this._bindFormResetHandler(), null == this.options.disabled &&
          ...
          this._addClass(this.label, "ui-checkboxradio-radio-label"), this
          .options.label && this.options.label !== this.originalLabel
          ? this._updateLabel()
          : this.originalLabel &&
      ...
      refresh: function() {
        ...
        this._updateIcon(t), this._toggleClass(
          this.label,
          "ui-checkboxradio-checked",
          "ui-state-active",
          t
        ), null !== this.options.label && this._updateLabel(), e !==
          this.options.disabled && this._setOptions({ disabled: e });
      }
    }
    ...
    _getCreateOptions: function() {
      var t,
        e = this._super() || {};
      return (this.isInput = this.element.is("input")), (t = this.element[0]
        .disabled), null != t && (e.disabled = t), (this.originalLabel = this
        .isInput
        ? this.element.val()
    ...
    _create: function() {
      !this.option.showLabel & !this.options.icon &&
        ...
        (this.options.disabled =
          this.element[0].disabled || !1), (this.hasTitle = !!this.element.attr(
        "title"
      )), this.options.label &&
        this.options.label !== this.originalLabel &&
        (this.isInput
          ? this.element.val(this.options.label)
          : this.element.html(this.options.label)), this._addClass(
        "ui-button",
        "ui-widget"
      ), this._setOption(
        "disabled",
    ...
    _enhance: function() {
      this.element.is("button") || this.element.attr("role", "button"), this
        .options.icon &&
    ...
    _updateIcon: function(e, i) {
      ...
      this.icon
        ...
        : (
          ...
          ), s && this._addClass(this.icon, null, i), this._attachIcon(n), o
        ? (
    ...
    _destroy: function() {
      this.element.removeAttr("role"), this.icon && this.icon.remove(), this
        .iconSpace && this.iconSpace.remove(), this.hasTitle ||
        ...
        (e
          ...
          : this.icon &&
            (
              this.icon.remove(),
              this.iconSpace && this.iconSpace.remove()
            )), "iconPosition" === t && this._updateIcon(t, e), "showLabel" ===
        t &&
        (
    ...
    refresh: function() {
      ...
      t !== this.options.disabled &&
        this._setOptions({ disabled: t }), this._updateTooltip();
    }
  }), t.uiBackCompat !== !1 &&
    (
  ...
  t.extend(s.prototype, {
    ...
    _attachments: function(e, i) {
      ...
      i.append && i.append.remove(), a &&
        ...
        ), e.off("focus", this._showDatepicker), i.trigger &&
    ...
    _dialogDatepicker: function(e, i, s, n, o) {
      ...
      return d ||
        ...
        i && i.constructor === Date
          ...
          : i), this._dialogInput.val(i), (this._pos = o
        ...
        .css(
          "top",
          this._pos[1] + "px"
        ), (d.settings.onSelect = s), (this._inDialog = !0), this.dpDiv.addClass(
        this._dialogClass
      ), this._showDatepicker(this._dialogInput[0]), t.blockUI &&
        t.blockUI(this.dpDiv), t.data(
        this._dialogInput[0],
        "datepicker",
        d
      ), this;
    ...
    _showDatepicker: function(e) {
      if (
        ...
        (s = t.datepicker._getInst(e)), t.datepicker._curInst &&
          ...
          ), (n = t.datepicker._get(s, "beforeShow")), (o = n
          ? n.apply(e, [e, s])
          : {}), o !== !1 &&
          (
            a(s.settings, o),
    ...
    _updateDatepicker: function(e) {
      ...
      r.length > 0 && o.apply(r.get(0)), e.dpDiv
        .removeClass(
        ...
        if (b) "'" !== e.charAt(n) || y("'") ? x() : (b = !1);
          ...
          switch (e.charAt(n)) {
            ...
            case "y":
              ...
              break;
            case "@":
              (r = new Date(w("@"))), (g = r.getFullYear()), (m =
    ...
    _generateHTML: function(t) {
      ...
      for (
        t.drawMonth = Z, t.drawYear = te, i = this._get(t, "prevText"), i = K
          ...
          this._get(t, "gotoCurrent") && t.currentDay ? G : B, a = K
          ...
          t,
          "beforeShowDay"
        ), _ = this._get(t, "showOtherMonths"), v = this._get(
          t,
          "selectOtherMonths"
        ...
        for (x = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
          if (
            ...
            if (((T += "<div class='ui-datepicker-group"), U[1] > 1))
              switch (C) {
                case 0:
                  (T += " ui-datepicker-group-first"), (I =
                    " ui-corner-" + (Y ? "right" : "left"));
                  break;
                case U[1] - 1:
                  (T += " ui-datepicker-group-last"), (I =
          ...
          for (
            ...
            (M = (w + c) % 7), (P +=
              ...
              "</span></th>");
          for (
            T += P + "</tr></thead><tbody>", S = this._getDaysInMonth(
              te,
              Z
            ), te === t.selectedYear &&
              Z === t.selectedMonth &&
              (t.selectedDay = Math.min(t.selectedDay, S)), H =
              (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, z = Math.ceil(
              (H + S) / 7
            ), O = X
              ? this.maxRows > z ? this.maxRows : z
              : z, this.maxRows = O, A = this._daylightSavingAdjust(
              new Date(te, Z, 1 - H)
            ), N = 0;
            O > N;
            N++
  ...
  t(document).on("mouseup", function() {
    ...
    _mouseMove: function(e) {
      ...
      return (e.which || e.button) && (this._mouseMoved = !0), this
        ._mouseStarted
    ...
    _mouseDrag: function(e, i) {
      ...
      return (this.helper[0].style.left =
        ...
        this.position.top + "px"), t.ui.ddmanager &&
    ...
    _mouseUp: function(e) {
      return this._unblockFrames(), t.ui.ddmanager &&
        ...
        this.element.trigger("focus"), t.ui.mouse.prototype._mouseUp.call(
        this,
        e
      );
    },
    ...
    drag: function(e, i, s) {
      t.each(s.sortables, function() {
        var n = !1,
          o = this;
        (o.positionAbs =
          s.positionAbs), (o.helperProportions = s.helperProportions), (o.offset.click = s.offset.click), o._intersectsWith(
          o.containerCache
        ) &&
          (
            (n = !0),
            t.each(s.sortables, function() {
              return (this.positionAbs =
                s.positionAbs), (this.helperProportions = s.helperProportions), (this.offset.click = s.offset.click), this !== o && this._intersectsWith(this.containerCache) && t.contains(o.element[0], this.element[0]) && (n = !1), n;
            })
          ), n
          ? (
              o.isOver ||
    ...
    start: function(e, i, s) {
      var n = t("body"),
        o = s.options;
      n.css("cursor") && (o._cursor = n.css("cursor")), n.css(
        "cursor",
        o.cursor
      );
    },
    ...
    start: function(e, i, s) {
      var n = t(i.helper),
        o = s.options;
      n.css("opacity") && (o._opacity = n.css("opacity")), n.css(
        "opacity",
        o.opacity
      );
    },
    ...
    drag: function(e, i, s) {
      ...
      for (d = s.snapElements.length - 1; d >= 0; d--)
        (h = s.snapElements[d].left - s.margins.left), (l =
          h + s.snapElements[d].width), (c =
          s.snapElements[d].top - s.margins.top), (u =
          c + s.snapElements[d].height), h - g > _ ||
        m > l + g ||
        c - g > b ||
        v > u + g ||
        !t.contains(
    ...
    start: function(e, i, s) {
      var n = t(i.helper),
        o = s.options;
      n.css("zIndex") && (o._zIndex = n.css("zIndex")), n.css(
        "zIndex",
        o.zIndex
      );
    },
    ...
    _setupHandles: function() {
      ...
      if (
        ...
        for (
          ...
          (e = t.trim(s[i])), (n = "ui-resizable-" + e), (o = t(
            "<div>"
          )), this._addClass(o, "ui-resizable-handle " + n), o.css({
            zIndex: a.zIndex
      ...
      )), this._handles.disableSelection(), this._handles.on(
        "mouseover",
        function() {
          r.resizing ||
            (
    ...
    _mouseStart: function(e) {
      ...
      return (this.resizing = !0), this._renderProxy(), (i = this._num(
      ...
      )), (s = this._num(this.helper.css("top"))), o.containment &&
        (
        ...
        : { width: a.width(), height: a.height() }), (this.originalSize = this
        ._helper
      ...
      ), this._addClass("ui-resizable-resizing"), this._propagate(
        "start",
        e
      ), !0;
    },
    ...
    _mouseStop: function(e) {
      ...
      return this._helper &&
        ...
        ), t("body").css("cursor", "auto"), this._removeClass(
    ...
    _applyChanges: function() {
      ...
      return this.position.top !== this.prevPosition.top &&
        ...
        this.prevPosition.left && (t.left = this.position.left + "px"), this
    ...
    _respectSize: function(t) {
      ...
      return o && (t.width = e.minWidth), a && (t.height = e.minHeight), s &&
        (t.width = e.maxWidth), n && (t.height = e.maxHeight), o &&
        l &&
        (t.left = r - e.minWidth), s && l && (t.left = r - e.maxWidth), a &&
        c &&
        (t.top = h - e.minHeight), n &&
        c &&
        (t.top = h - e.maxHeight), t.width || t.height || t.left || !t.top
    ...
    _create: function() {
      (this.originalCss = {
        ...
        (this.options.disabled = !1), this._createWrapper(), this.element
        .show()
        .removeAttr("title")
    ...
    _moveToTop: function(e, i) {
      ...
      return o >= +this.uiDialog.css("z-index") &&
        (this.uiDialog.css("z-index", o + 1), (s = !0)), s &&
        !i &&
    ...
    _createTitlebar: function() {
      ...
      (this.uiDialogTitlebar = t("<div>")), this._addClass(
        ...
        e,
        "ui-dialog-title"
      ), this._title(e), this.uiDialogTitlebar.prependTo(
        this.uiDialog
      ...
      (t.isArray(i) && !i.length)
        ...
        : (
            t.each(i, function(i, s) {
              ...
              (s = t.isFunction(s)
                ? { click: s, text: i }
                : s), (s = t.extend({ type: "button" }, s)), (n = s.click), (o = { icon: s.icon, iconPosition: s.iconPosition, showLabel: s.showLabel, icons: s.icons, text: s.text }), delete s.click, delete s.icon, delete s.iconPosition, delete s.showLabel, delete s.icons, "boolean" == typeof s.text && delete s.text, t("<button></button>", s).button(o).appendTo(e.uiButtonSet).on("click", function() {
      ...
      this.uiDialog.draggable({
        ...
        start: function(s, n) {
          i._addClass(
            t(this),
            "ui-dialog-dragging"
          ), i._blockFrames(), i._trigger("dragStart", s, e(n));
        },
        drag: function(t, s) {
    ...
    _addToManager: function(e) {
      (t.ui.ddmanager.droppables[e] =
        t.ui.ddmanager.droppables[e] || []), t.ui.ddmanager.droppables[e].push(
        this
      );
    },
    _splice: function(t) {
  ...
  (t.ui.ddmanager = {
    ...
    dragStop: function(e, i) {
      e.element.parentsUntil("body").off("scroll.droppable"), e.options
    ...
    _create: function() {
      (this.oldValue = this.options.value = this._constrainedValue()), this.element.attr(
        ...
        "ui-progressbar",
        "ui-widget ui-widget-content"
      ), (this.valueDiv = t("<div>").appendTo(this.element)), this._addClass(
        this.valueDiv,
    ...
    t.ui.formResetMixin,
    {
      ...
      _drawButton: function() {
        ...
        (this.labels = this.element
          ...
          "ui-button ui-widget"
        ), (e = t("<span>").appendTo(this.button)), this._addClass(
          e,
          "ui-selectmenu-icon",
          "ui-icon " + this.options.icons.button
        ), (this.buttonItem = this._renderButtonItem(s).appendTo(
          this.button
        )), this.options.width !== !1 && this._resizeButton(), this._on(
          this.button,
          this._buttonEvents
          ...
          .menu({
            ...
            focus: function(t, i) {
              ...
              null != e.focusIndex &&
                ...
                ), (e.focusIndex = s.index), e.button.attr(
                "aria-activedescendant",
      ...
      _refreshMenu: function() {
        ...
        this.menu.empty(), this._parseOptions(e), this._renderMenu(
          this.menu,
          this.items
        ), this.menuInstance.refresh(), (this.menuItems = this.menu
          .find("li")
      ...
      _renderItem: function(e, i) {
        ...
        return i.disabled &&
          this._addClass(s, null, "ui-state-disabled"), this._setText(
          n,
          i.label
      ...
      _setOptionDisabled: function(t) {
        this._super(t), this.menuInstance.option(
          "disabled",
          t
        ), this.button.attr("aria-disabled", t), this._toggleClass(
          this.button,
          null,
          "ui-state-disabled",
          t
        ), this.element.prop("disabled", t), t
      ...
      _appendTo: function() {
        ...
        return e &&
          (e =
            e.jquery || e.nodeType ? t(e) : this.document.find(e).eq(0)), (e &&
          e[0]) ||
          (e = this.element.closest(".ui-front, dialog")), e.length ||
          (e = this.document[0].body), e;
      },
    ...
    _refreshRange: function(t) {
      "vertical" === t &&
        this.range.css({ width: "", left: "" }), "horizontal" === t &&
    ...
    _mouseStart: function(e, i, s) {
      ...
      return t.ui.ddmanager && (t.ui.ddmanager.current = this), t.ui
        ...
        t.ui.ddmanager.prepareOffsets(
          this,
          e
        ), (this.dragging = !0), this._addClass(
        this.helper,
        "ui-sortable-helper"
      ), this._mouseDrag(e), !0;
    },
    ...
    cancel: function() {
      if (this.dragging) {
        this._mouseUp(new t.Event("mouseup", { target: null })), "original" ===
        this.options.helper
          ? (
    ...
    _contactContainers: function(e) {
      ...
      if (d)
        if (1 === this.containers.length)
          ...
          for (
            n = 1e4, o = null, c =
              d.floating || this._isFloating(this.currentItem), a = c
              ? "left"
              : "top", r = c ? "width" : "height", u = c
              ? "pageX"
              : "pageY", s = this.items.length - 1;
            s >= 0;
            s--
          )
          ...
          o
            ...
            : this._rearrange(
                ...
                !0
              ), this._trigger("change", e, this._uiHash()), this.containers[
            p
          ]._trigger(
            "change",
            e,
    ...
    _clear: function(t, e) {
      ...
      for (
        ...
        e || n.push(i("deactivate", this, this.containers[s])), this.containers[
          s
        ].containerCache.over &&
          (
    ...
    _draw: function() {
      this._enhance(), this._addClass(
        ...
        "ui-spinner",
        "ui-widget ui-widget-content"
      ), this._addClass("ui-spinner-input"), this.element.attr(
        "role",
        "spinbutton"
        ...
        .attr("tabIndex", -1)
        .attr("aria-hidden", !0)
        .button({ classes: { "ui-button": "" } })), this._removeClass(
        this.buttons,
        "ui-corner-all"
      ), this._addClass(
        this.buttons.first(),
    ...
    _setOptionDisabled: function(t) {
      this._super(t), this._toggleClass(
        ...
        "ui-state-disabled",
        !!t
      ), this.element.prop("disabled", !!t), this.buttons.button(
        t ? "disable" : "enable"
      );
    },
    ...
    _processTabs: function() {
      ...
      (this.tablist = this._getList().attr("role", "tablist")), this._addClass(
        ...
        .find("> li:has(a[href])")
        .attr({ role: "tab", tabIndex: -1 })), this._addClass(
        this.tabs,
        "ui-tabs-tab",
        "ui-state-default"
        ...
        e._isLocal(s)
          ...
          : (
            ...
            ), o.length && (e.panels = e.panels.add(o)), l && h.data("ui-tabs-aria-controls", l), h.attr({ "aria-controls": a, "aria-labelledby": r }), o.attr("aria-labelledby", r);
    ...
    _setOptionDisabled: function(e) {
      ...
      (this.options.disabled = e), this._toggleClass(
        this.widget(),
        this.widgetFullName + "-disabled",
        null,
        e === !0
    ...
    _destroy: function() {
      this.xhr && this.xhr.abort(), this.tablist
        .removeAttr("role")
    ...
    _create: function() {
      this._on({
        mouseover: "open",
        focusin: "open"
      }), (this.tooltips = {}), (this.parents = {}), (this.liveRegion = t(
        "<div>"
      )
        .attr({
          role: "log",
    ...
    _open: function(e, i, s) {
      ...
      if (s) {
        ...
        i.is("[title]") &&
          (e && "mouseover" === e.type
            ? i.attr("title", "")
            : i.removeAttr("title")), (o = this._tooltip(i)), (a =
          o.tooltip), this._addDescribedBy(i, a.attr("id")), a
          .find(".ui-tooltip-content")
          .html(s), this.liveRegion.children().hide(), (h = t("<div>").html(
        ...
        /^mouse/.test(e.type)
          ...
          : a.position(
            ...
            ), a.hide(), this._show(a, this.options.show), this.options.track &&
          this.options.show &&
    ...
    _tooltip: function(e) {
      ...
      return this._addClass(s, "ui-tooltip-content"), this._addClass(
        i,
        "ui-tooltip",
        "ui-widget ui-widget-content"
    ...
    _destroy: function() {
      ...
      t.each(this.tooltips, function(i, s) {
        ...
        (n.target = n.currentTarget =
          o[0]), e.close(n, !0), t("#" + i).remove(), o.data("ui-tooltip-title") && (o.attr("title") || o.attr("title", o.data("ui-tooltip-title")), o.removeData("ui-tooltip-title"));
